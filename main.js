...
var winHei;
var z = 3;
function ball(obj, x, y, bx, by, size,inc,oColor, cColor) {
    this.obj = obj;
    this.x = x;
    this.y = y;
    this.bx = bx;
...
function setter(){
    ...
    box1 = new ball(box,199,10,"+","+",200,2,"#44037A","blue"); 
    holder.push(box1);
    
    box = document.getElementById("projects");
    box1 = new ball(box, 300, 100, "+", "-", 100,2,"#9E3354","red");
    holder.push(box1);
    
    box = document.getElementById("contact");
    box1 = new ball(box, 200, 200, "-" , "+", 75,3,"#26755D", "green");
    holder.push(box1);
}
